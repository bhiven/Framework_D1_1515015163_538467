...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<a href="{{url('jadwal_matakuliah/tambah')}}" class="btn btn-xs btn-primary pull-right">
			<i class="fa fa-plus"></i> Jadwal Mahasiswa
		</a>
		...
		<tbody>
			...
			@foreach ($semuaJadwalMatakuliah as $jadwal)
				<tr>
					...
					<td>
						{{ $jadwal->mahasiswa->nama or 'nama kosong'}}
					</td>
					<td>
						{{ $jadwal->mahasiswa->nim or 'nim kosong'}}
					</td>
					<td>
						{{ $jadwal->dosen_matakuliah->matakuliah->title or 'matakuliah kosong'}}
					</td>
					...
					<td>
						<div class="btn-group" role="group">
							...
							<a href="{{url('jadwal_matakuliah/'.$jadwal->id)}}" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="top" title="Lihat">
								<i class="fa fa-eye"></i>
							</a>
